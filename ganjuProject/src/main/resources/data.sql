...
('쌀밥', 2000, @categoryId1, 'ssalbap.png', '찰진 흰밥', @restaurantId1),
('콩밥', 3000, @categoryId1, 'kongbap.png', '영양 가득 콩밥', @restaurantId1),
('보리밥', 5000, @categoryId1, 'boribap.png', '영양 가득 보리밥', @restaurantId1),
('흑미밥', 6000, @categoryId1, 'heukmibap.png', '구수한 흑미밥', @restaurantId1);

-- '국류' 카테고리에 메뉴 추가
INSERT INTO menu (name, price, category_id, menu_image, info, restaurant_id) VALUES
('김치찌개', 7000, @categoryId2, 'kimchijjigae.png', '매콤하고 깊은 맛의 김치찌개', @restaurantId1),
('된장찌개', 8000, @categoryId2, 'doenjangjjigae.png', '구수한 된장의 풍미가 가득한 된장찌개', @restaurantId1),
('콩나물국', 9000, @categoryId2, 'kongnamulguk.png', '시원하고 깔끔한 맛의 콩나물국', @restaurantId1),
('육개장', 9000, @categoryId2, 'yukgaejang.png', '얼큰하고 진한 맛의 육개장', @restaurantId1),
('미역국', 8000, @categoryId2, 'miyeokguk.png', '영양 가득 미역국', @restaurantId1);

-- '주류' 카테고리에 메뉴 추가
INSERT INTO menu (name, price, category_id, menu_image, info, restaurant_id) VALUES
('콜라', 2000, @categoryId3, 'cola.png', '시원하게 제공되는 콜라', @restaurantId1),
('사이다', 2000, @categoryId3, 'cider.png', '청량한 사이다', @restaurantId1),
('환타', 2000, @categoryId3, 'fanta.png', '달콤한 오렌지맛 환타', @restaurantId1),
('소주', 4000, @categoryId3, 'soju.png', '깔끔하고 시원한 소주', @restaurantId1),
('맥주', 5000, @categoryId3, 'beer.png', '상쾌한 맥주', @restaurantId1);

-- '반찬' 카테고리에 메뉴 추가
INSERT INTO menu (name, price, category_id, menu_image, info, restaurant_id) VALUES
('메밀전병', 2000, @categoryId4, 'memiljeonbyeong.png', '고소한 메밀전병', @restaurantId1),
('계란말이', 2000, @categoryId4, 'eggroll.png', '부드러운 계란말이', @restaurantId1),
('강된장', 2000, @categoryId4, 'strongdoenjang.png', '집에서 만든 강된장', @restaurantId1),
('장조림', 3000, @categoryId4, 'jangjorim.png', '달콤 짭짤한 장조림', @restaurantId1);

-- '요리류' 카테고리에 메뉴 추가
INSERT INTO menu (name, price, category_id, menu_image, info, restaurant_id) VALUES
('불고기', 9000, @categoryId5, 'bulgogi.png', '달콤하고 육즙 가득한 불고기', @restaurantId1),
('제육볶음', 10000, @categoryId5, 'jeyukbokkeum.png', '매콤 달콤한 제육볶음', @restaurantId1),
('신선로', 30000, @categoryId5, 'shinseonro.png', '다양한 재료가 가득한 신선로', @restaurantId1),
('고등어조림', 15000, @categoryId5, 'mackereljorim.png', '양념이 잘 배인 고등어조림', @restaurantId1),
('삼겹살', 12000, @categoryId5, 'samgyeopsal.png', '쫄깃한 삼겹살', @restaurantId1);
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '김치찌개')), 2000);
...
INSERT INTO menu_option_value (content, menu_option_id, price) VALUES
('고기추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '김치찌개')), 3000),
('참치추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '김치찌개')), 2000),
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '된장찌개')), 2000);
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '콩나물국')), 2000);
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '육개장')), 2000);
...
INSERT INTO menu_option_value (content, menu_option_id, price) VALUES
('고기추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '육개장')), 3000),
('참치추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '육개장')), 2000),
('라면사리', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '육개장')), 1500);
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '미역국')), 2000);

INSERT INTO menu_option_value (content, menu_option_id, price) VALUES
('고기추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '미역국')), 3000);
...
('1.25L', (SELECT id FROM menu_option WHERE content = '사이즈' AND menu_id = (SELECT id FROM menu WHERE name = '콜라')), 1000),
('500ml', (SELECT id FROM menu_option WHERE content = '사이즈' AND menu_id = (SELECT id FROM menu WHERE name = '사이다')), 0),
('1.25L', (SELECT id FROM menu_option WHERE content = '사이즈' AND menu_id = (SELECT id FROM menu WHERE name = '사이다')), 1000),
('500ml', (SELECT id FROM menu_option WHERE content = '사이즈' AND menu_id = (SELECT id FROM menu WHERE name = '환타')), 0),
('1.25L', (SELECT id FROM menu_option WHERE content = '사이즈' AND menu_id = (SELECT id FROM menu WHERE name = '환타')), 1000);
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '불고기')), 500);

-- '불고기' 메뉴의 추가선택 옵션 값 추가
INSERT INTO menu_option_value (content, menu_option_id, price) VALUES
('고기 추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '불고기')), 3000),
('버섯 추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '불고기')), 1500);
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '제육볶음')), 500);

-- '제육볶음' 메뉴의 추가선택 옵션 값 추가
INSERT INTO menu_option_value (content, menu_option_id, price) VALUES
('고기 추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '제육볶음')), 3000),
('버섯 추가', (SELECT id FROM menu_option WHERE content = '추가선택' AND menu_id = (SELECT id FROM menu WHERE name = '제육볶음')), 1500);
...
('곱빼기', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '고등어조림')), 3000);
...
('고기추가(500g)', (SELECT id FROM menu_option WHERE content = '기본' AND menu_id = (SELECT id FROM menu WHERE name = '삼겹살')), 5000);
...
-- 주문 정보 삽입 예시
INSERT INTO orders (restaurant_table_no, menu_id, price, reg_date, restaurant_id, content, uid)
VALUES
    (1, 1, 10000, '2024-04-01 12:00:00',@restaurantId1, '김치찌개와 쌀밥 주문', 'UID123'),
    (2, 2, 12000, '2024-04-01 12:10:00',@restaurantId1, '된장찌개 곱빼기 주문', 'UID124'),
    (3, 3, 8000, '2024-04-02 13:00:00',@restaurantId1, '콩나물국 주문', 'UID125'),
    (4, 4, 9000, '2024-04-02 13:20:00',@restaurantId1, '육개장 주문', 'UID126'),
    (5, 5, 7000, '2024-04-03 18:00:00',@restaurantId1, '미역국 주문', 'UID127'),
    (1, 6, 20000, '2024-04-03 18:30:00',@restaurantId1, '불고기 주문', 'UID128'),
    (2, 7, 15000, '2024-04-04 19:00:00',@restaurantId1, '제육볶음 주문', 'UID129'),
    (3, 8, 18000, '2024-04-04 19:30:00',@restaurantId1, '신선로 주문', 'UID130'),
    (4, 9, 22000, '2024-04-05 20:00:00',@restaurantId1, '고등어조림 주문', 'UID131'),
    (5, 10, 25000, '2024-04-05 20:30:00',@restaurantId1, '삼겹살 주문', 'UID132');

...
VALUES
    ...
    (6, 2, 6300, '2024-04-23 09:30:00', '짜장면, 탕수육, 맥주 주문', 'user6', 'WAIT'),
    (7, 1, 28300, '2024-04-23 08:00:00', '피자, 샐러드, 콜라 주문', 'user7', 'WAIT'),
    (8, 2, 27300, '2024-04-22 08:30:00', '파스타, 스프, 와인 주문', 'user8', 'WAIT'),
    (9, 1, 30000, '2024-04-22 09:00:00', '스테이크, 맥주, 감자튀김 주문', 'user9', 'WAIT'),
    (10, 2, 59800, '2024-04-22 10:30:00', '짜장면, 짬뽕, 맥주, 탕수육 주문', 'user10', 'WAIT'),
    (11, 1, 21800, '2024-04-21 14:00:00', '스파게티, 샐러드 주문', 'user11', 'WAIT'),
    (12, 2, 29300, '2024-04-21 15:30:00', '피자, 맥주, 스프 주문', 'user12', 'WAIT'),
    (13, 1, 24100, '2024-04-20 17:00:00', '스테이크, 와인 주문', 'user13', 'WAIT'),
    (14, 2, 27000, '2024-04-19 18:30:00', '짜장면, 짬뽕, 맥주 주문', 'user14', 'WAIT'),
    (15, 1, 19000, '2024-04-18 20:00:00', '피자, 감자튀김 주문', 'user15', 'WAIT'),
    (16, 2, 25000, '2024-04-17 21:30:00', '파스타, 샐러드, 와인 주문', 'user16', 'WAIT'),
    (17, 1, 30000, '2024-04-16 14:00:00', '짜장면, 탕수육, 콜라 주문', 'user17', 'WAIT'),
    (18, 2, 28000, '2024-04-15 15:30:00', '그릴드 스테이크, 맥주, 감자튀김 주문', 'user18', 'WAIT');
